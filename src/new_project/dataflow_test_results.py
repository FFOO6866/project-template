...
def print_dataflow_test_summary():
    ...
    print("├─────────────────────────────┼────────┼─────────────────────┤")
    print("│ DataFlow Import             │   ✅   │ Working             │")
    print("│ @db.model Decorator         │   ❌   │ Needs PostgreSQL    │")
    print("│ Auto-Generated Nodes        │   ❌   │ Needs PostgreSQL    │")
    print("│ Database Initialization     │   ❌   │ PostgreSQL only     │")
    print("│ Zero-Config Experience     │   ❌   │ Requires PG setup   │")
    print("│ Windows Compatibility       │   ✅   │ Patch applied       │")
    print("│ Core Workflow Execution     │   ✅   │ Working perfectly   │")
    print("│ Manual SQL Operations       │   ✅   │ Full functionality  │")
    print("│ SQLite Database Operations  │   ✅   │ Via SQL nodes       │")
    print("└─────────────────────────────┴────────┴─────────────────────┘")
